...
namespace Online_Medical.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Email,Phone,Password,Gender,ExperienceYears,Bio,ProfileImage,SpecializationId")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Email,Phone,Password,Gender,ExperienceYears,Bio,ProfileImage,SpecializationId")] Doctor doctor)
        {
            if (id != doctor.Id)
            {
                return NotFound();
