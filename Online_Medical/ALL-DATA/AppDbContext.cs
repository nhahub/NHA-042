...
namespace Online_Medical.ALL_DATA
{
    ...
    =>      optionsBuilder.UseSqlServer("Data Source=William;Initial Catalog=Educational_Institution;Integrated Security=True;Encrypt=False;Trust Server Certificate=True");
